...
function addUsers($data){
    $conn = db_conn();
    $selectQuery = "INSERT INTO user_info( Name ,Email, Dob, Gender, User_Name, Password,Picture )
...
function updateUsers($data){
    $conn = db_conn();
    $selectQuery = "UPDATE user_info set Name = ?, Password = ?, Picture = ? where User_Name = ?";
...
VALUES (:Id,:name,:buyPrice,:sellPrice,:image)";
    ...
    try{
        ...
        echo $e->getMessage();
        echo '<h1 align="center" style="color:red">Duplicate Entry</h1>';
    }
